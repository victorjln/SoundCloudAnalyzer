...
document.getElementById("searchImg").addEventListener("click", function(){document.getElementById("search").style.transform = "animation : fadeInUp 0.5 ease-in-out forwards;"});